...
ImportTableDialog::ImportTableDialog(QWidget *parent) :
    ProcessParametersDialog(parent),
    ui(new Ui::ImportTableDialog)
{
    ui->setupUi(this);
...
QMap<QString,QString> ImportTableDialog::params(){
...
void ImportTableDialog::setProject(AVOProject * p){
...
void ImportTableDialog::setFormat(QString s){
    setFormat(toGridFormat(s));
}

void ImportTableDialog::setFormat(GridFormat f){
...
void ImportTableDialog::setCoord1Column( int col ){
...
// col is assumed 1-based
void ImportTableDialog::setCoord2Column( int col ){
...
// col is assumed 1-based
void ImportTableDialog::setValueColumn( int col ){
...
void ImportTableDialog::on_pbBrowse_clicked()
{
    QString fn=QFileDialog::getOpenFileName(0, "Select table file");
...
void ImportTableDialog::updatePreview(const QString& filename)
{
...
void ImportTableDialog::on_pbScan_clicked()
{
    scan();
}

bool ImportTableDialog::splitLine( const QString& line, qreal& coord1, qreal& coord2, double& value){
...
//       std::cout<<col.size()<<" "<<m_inlineColumn <<" "<<m_crosslineColumn<<" "<<m_valueColumn<<" "<<m_lastUsedColumn<<std::endl;
 ...
 void ImportTableDialog::updateLastUsedColumn(){
 ...
 void ImportTableDialog::updateCoordLabels(){
     ...
     case GridFormat::ILXLZ:
         ...
         break;
     default:
         qFatal("Unhandled format in ImportTableDialog!");
         break;
     }

 }

 void ImportTableDialog::updateOkButton(){
     ...
     QPalette palette;
     if( oname.isEmpty() || m_project->existsTable(oname) ){    // make sure not to call existsgrid with empty name!!!
         ok=false;
